...
class ChatCostChart extends Component {
    ...
    getChatsCostMonthly = async () => {
        const server_response = await ajaxCallStation.chatCostEachMonth();
                ...
                <div className="card height-auto" style={{ borderRadius: '10px' }}>
                    <div className="card-body">
                        <div className="card-option d-flex">
                            <div>
                                <h6 className="card-title mb-1">Buzz chat Charges</h6>
                            </div>
