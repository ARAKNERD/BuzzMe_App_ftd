...
//     setLoading2(true);
//     const server_response = await ajaxStudent.fetchStudentList(props.school,page);
//     setLoading2(false);
...
//                               target="_blank "
//                               to={`/students/student_card/${item.id}/null`}>
//                               View
//                             </Link>
//                           </td>
//                         </tr>
...
//                             className="btn btn-info"
//                               target="_blank "
//                               to={`/students/student_card/${student.id}/null`}>
//                               View
//                             </Link>
//                           </td>
//                         </td>
