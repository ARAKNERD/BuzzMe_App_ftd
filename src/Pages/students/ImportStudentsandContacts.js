...
const ImportStudentsandContacts = () => {
    ...
    <AppContainer title="Import Students and Contacts">
        <div className="row">
            <div className="col-12 col-xl-12">
                ...
                <div className="box user-pro-list overflow-hidden mb-30" style={{
                    marginBottom: "30px", backgroundColor: "white", padding: "25px", boxShadow: "10px",borderRadius: "10px",
                }}>
                    ...
                    {excelData.length > 0 && (
                        <div>
                            <h3 style={{ marginTop: 20, marginBottom: 20, textAlign: "center" }}>Excel Data To Be Imported:</h3>
...
export default ImportStudentsandContacts;
