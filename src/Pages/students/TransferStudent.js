...
function TransferStudent() {
  ...
  const searchNumber =async(e)=>{
    ...
    setLoading(true)
    const server_response = await ajaxStudent.searchStudentByNumber(searchedBuzzNo);
    setLoading(false)
      ...
      <div className="row">
        ...
        <div className="card custom-card" style={{borderRadius: "10px"}}>
            <div className="card-body">
              <div>
                <h5 style={{marginBottom:0}} className="card-title">Student Search</h5>
                <p style={{color:"#042954"}}><small>Search for student to be transferred.</small></p>
                ...
                {numberSearch && (
                  <tbody>
                    <tr>
                      ...
                      <td className="py-2 px-0">
                        {" "}
                        <span className="">{numberSearch.full_name}</span>{" "}
                      </td>
                    </tr>
                    <tr>
                      <td className="py-2 px-0">
