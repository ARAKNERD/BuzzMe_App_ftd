...
{/* <div className="row">
                            ...
                            <div className="table-responsive">
                                <table className="table mb-0 mw-100 color-span">
                                    {studentProfile && <tbody>
                                        ...
                                        <tr>
                                            <td className="py-2 px-0"> <span className="w-50">Wallet Balance</span> </td>
                                            <td>:</td>
                                            <td className="py-2 px-0"> <span className="">{studentProfile.wallet_balance}</span> </td>
                                        </tr>
                                    </tbody>}
                                </table>
                                {loading && <Loader/>}
 ...
 <div className="col-6 col-xl-6">
        ...
        <div className="col-6 col-xl-6"><div className="card height-auto" >
                    <div className="card-body map-card">
                        <TableHeader
                            title="Call Logs"
                ...
                <div className="col-6 col-xl-6"><div className="card height-auto" >
                    <div className="card-body map-card">
                        <TableHeader
                            ...
                            subtitle="List of all the transactions involved with the student" 
